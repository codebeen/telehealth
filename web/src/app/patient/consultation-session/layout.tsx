    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col font-sans">
      ...
      <header className="bg-white border-b border-slate-100/70 h-16 px-6 flex items-center justify-between shrink-0 shadow-xs">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-sm font-extrabold text-slate-900 tracking-tight leading-none">Telehealth Session</h1>
            <span className="text-[9px] text-slate-500 font-bold uppercase tracking-wider block mt-1">Live Video Consult</span>
          </div>
        </div>
